...
var Main = function () {
    ...
    var runModuleTools = function () {
        ...
        $('.panel-tools .panel-refresh').bind('click', function (e) {
            ...
            el.block({
                ...
                message: '<img src="' + BASE_URL + '/public/images/co/loading.gif" /> Just a moment...',
                css: {
                    border: 'none',
                    color: '#333',
                    background: 'none'
    ...
    var setColorScheme = function () {
        $('.icons-color a').bind('click', function () {
            ...
            $('#skin_color').attr("href", BASE_URL + "/public/css/co/theme_" + $(this).attr('id') + ".css");
    ...
    var runActivateLess = function () {
        ...
        if ($('#skin_color').attr("rel") == "stylesheet") {
            $('#skin_color').attr("rel", "stylesheet/less").attr("href", BASE_URL + "/public/less/co/styles.less");
